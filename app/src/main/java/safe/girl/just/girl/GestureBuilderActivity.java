...
public class GestureBuilderActivity extends ListActivity {
    ...
    private class GesturesLoadTask extends AsyncTask<Void, NamedGesture, Integer> {
        ...
        protected void onPreExecute() {
            ...
            mThumbnailInset = (int) resources.getDimension(R.dimen.activity_horizontal_margin);
            mThumbnailSize = (int) resources.getDimension(R.dimen.activity_vertical_margin);
